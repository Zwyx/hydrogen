...
import type {AddressFragment, CustomerFragment} from 'customerapi.generated';
import {
  json,
  redirect,
...
} from 'app/graphql/customer/CustomerAddressMutations';
    ...
    <Form id={addressId}>
      <fieldset>
        ...
        <input
          ...
          type="text"
        />
        <label htmlFor="territoryCode">Country/Territory Code*</label>
        <input
